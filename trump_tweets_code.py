...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 16:22:25 2019

Applied Statistical Methods Final Project
Code Used to Download @realDonaldTrump Twitter Timeline
...
# Get 17 sets of 200 tweets from @realDonaldTrump
...
for i in range(REPEATS):
    ...
    # parameter with the last id of tweet_list - 1
        ...
        print('No more available tweets')
        continue
    
    else:
        # Update max_id so that I get continuous stream of tweets:
